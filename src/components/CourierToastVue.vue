...
const emits = defineEmits<{
  (e: 'item:click', value: CourierToastItemClickEvent): void;
  (e: 'action:click', value: CourierToastItemActionClickEvent): void;
}>();
...
watch(toast, t => {
  ...
  // t.onToastItemActionClick(props => emits('action:click', props));
});
</script>
